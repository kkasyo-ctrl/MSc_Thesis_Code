...
df = pd.read_csv(r'C:\Users\david\Desktop\MSc Thesis\MSc Code\github\MSc_Thesis_Code\rbai_llm\output_rbai_llm.csv', encoding='latin1')
df_copy = df.copy()
...
df_copy.to_csv(r'C:\Users\david\Desktop\MSc Thesis\MSc Code\github\MSc_Thesis_Code\rbai_llm\output_rbai_llm_offers_fixed.csv', index=False, encoding='latin1')