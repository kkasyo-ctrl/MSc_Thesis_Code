...
import time
from rbai_rbai import pareto_rbai_b1
import re
...
def extract_constraint(text):
    ...
    if integers:
        ...
        context_constraint = PROMPTS['context_constraint'][rbai_storage_b1.bot1_role]
...
def get_greediness(constraint_bot2: int, constraint_bot: int) -> int:
    if constraint_bot2 not in (0, None):
        return pareto_rbai_b1.pareto_efficient_offer(constraint_bot2, constraint_bot,
